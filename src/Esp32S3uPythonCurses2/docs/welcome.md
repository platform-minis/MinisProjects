...
A **continuation of the ESP32-S3 MicroPython course** introducing the MAX7219 8×8 LED matrix (SPI), KY-018 light sensor (ADC), AHT20+BMP280 sensors (I2C), and more. This is part 2 — if you haven't completed part 1 (Esp32S3uPythonCurses), start there first.
...
- AHT20 temperature & humidity sensor module (I2C)
- BMP280 barometric pressure sensor module (I2C)
...
| `Lesson15`  | AHT20+BMP280 — I2C temperature, humidity & pressure, Bosch compensation |
