...
Blockly.defineBlocksWithJsonArray([
  ...
  },
  {
    ...
    nextStatement: null,
    colour: 120,
    tooltip: 'Trigger one AHT20 measurement (~80 ms). Call before reading temperature or humidity.',
  },
  {
    type: 'aht_temp',
  ...
  },
  {
    ...
    nextStatement: null,
    colour: 160,
    tooltip: 'Read temperature and pressure from BMP280. Call before bmp_temp / bmp_pres.',
  },
  {
    type: 'bmp_temp',
    ...
    output: 'Number',
    colour: 160,
    tooltip: 'Return temperature in °C from the last BMP280 reading.',
  },
  {
    type: 'bmp_pres',
    ...
    output: 'Number',
    colour: 160,
    tooltip: 'Return pressure in hPa from the last BMP280 reading.',
  },
]);
...
def _aht_bmp_init():
    global _bmp_cal
    _i2c.writeto(_AHT_ADDR, bytes([0xBE, 0x08, 0x00]))
    time.sleep_ms(20)
    _i2c.writeto_mem(_BMP_ADDR, 0xF4, bytes([0xB7]))
    time.sleep_ms(10)
    c = _i2c.readfrom_mem(_BMP_ADDR, 0x88, 24)
...
def _aht_measure():
    ...
    _i2c.writeto(_AHT_ADDR, bytes([0xAC, 0x33, 0x00]))
    time.sleep_ms(80)
    d = _i2c.readfrom(_AHT_ADDR, 6)
...
def _bmp_measure():
    ...
    cal = _bmp_cal
    r = _i2c.readfrom_mem(_BMP_ADDR, 0xF7, 6)
