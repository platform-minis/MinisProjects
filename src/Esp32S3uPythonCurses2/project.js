...
Blockly.defineBlocksWithJsonArray([
  {
    type: 'dht11_measure',
    message0: 'DHT11 measure (GP10)',
    previousStatement: null,
    nextStatement: null,
    colour: 120,
    tooltip: 'Trigger one measurement on the DHT11 sensor (DATA=GP10). Call before reading temperature or humidity.',
  },
  {
    type: 'dht11_temp',
